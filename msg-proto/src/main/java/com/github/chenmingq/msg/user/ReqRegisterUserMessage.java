...
@Setter
@Getter
public class ReqRegisterUserMessage extends AbstractMessage {

	private com.github.chenmingq.proto.UserProto.ReqRegisterMessage proto;

	@Override
	public void deCoder(byte[] body) {
		try {
			this.proto = com.github.chenmingq.proto.UserProto.ReqRegisterMessage.parseFrom(body);
